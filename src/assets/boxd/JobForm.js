...
var $author$project$JobForm$Model = F5(
	function (view, maybeFile, fullName, email, message) {
		return {email: email, fullName: fullName, maybeFile: maybeFile, message: message, view: view};
	});
var $elm$core$Maybe$Nothing = {$: 'Nothing'};
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$JobForm$View = function (a) {
	return {$: 'View', a: a};
};
...
var $author$project$JobForm$FieldEmail = {$: 'FieldEmail'};
var $author$project$JobForm$FieldFullName = {$: 'FieldFullName'};
var $author$project$JobForm$FieldMessage = {$: 'FieldMessage'};
var $author$project$JobForm$Input = F2(
	function (a, b) {
		return {$: 'Input', a: a, b: b};
	});
var $author$project$JobForm$SelectFile = {$: 'SelectFile'};
var $author$project$JobForm$Submit = {$: 'Submit'};
...
var $author$project$JobForm$form = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('card card-border bmrder-primary shadow-light-lg')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onSubmit($author$project$JobForm$Submit)
							]),
						_List_fromArray(
							[
								A2(
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('form-group mb-5')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$for('applyFullName')
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Attributes$id('applyFullName'),
																$elm$html$Html$Attributes$placeholder('Full name'),
																$elm$html$Html$Events$onInput(
																$author$project$JobForm$Input($author$project$JobForm$FieldFullName))
															]),
														_List_Nil)
													]))
											])),
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$for('applyEmail')
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Attributes$class('form-control'),
																$elm$html$Html$Attributes$required(true),
																$elm$html$Html$Attributes$id('applyEmail'),
																$elm$html$Html$Attributes$placeholder('Enter your email'),
																$elm$html$Html$Events$onInput(
																$author$project$JobForm$Input($author$project$JobForm$FieldEmail))
															]),
														_List_Nil)
													]))
											])),
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text('Attachment (must be less than 5mb and file type is JPEG/PNG/PDF)')
															])),
														A2(
														$elm$html$Html$a,
														_List_fromArray(
															[
																...
																$elm$html$Html$Events$onClick($author$project$JobForm$SelectFile)
															]),
														_List_fromArray(
															[
																$elm$html$Html$text(
																function () {
																	var _v0 = model.maybeFile;
																	if (_v0.$ === 'Just') {
																		var file = _v0.a;
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$for('applyMessage')
															]),
														_List_fromArray(
															[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$id('applyMessage'),
																$elm$html$Html$Attributes$rows(5),
																$elm$html$Html$Attributes$class('form-control'),
																$elm$html$Html$Attributes$placeholder('(Optional)'),
																$elm$html$Html$Events$onInput(
																$author$project$JobForm$Input($author$project$JobForm$FieldMessage))
															]),
														_List_Nil)
													]))
											]))
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('btn btn-primary mb-6 mb-md-0 lift')
													]),
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('fe fe-arrow-right ml-3')
															]),
														_List_Nil)
													]))
											])),
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('col-12 col-md-auto')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('font-size-sm text-muted mb-0')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Your application will be sent securely and remain private.')
													]))
											]))
									]))
							]))
...
var $author$project$JobForm$FileSelected = function (a) {
	return {$: 'FileSelected', a: a};
};
var $author$project$JobForm$Submitted = function (a) {
...
var $author$project$JobForm$failed = function (model) {
	return A2(
		$elm$html$Html$h3,
		_List_fromArray(
			[
...
var $author$project$JobForm$submitted = function (model) {
	return A2(
		$elm$html$Html$h3,
		_List_fromArray(
			[
...
var $author$project$JobForm$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SelectFile':
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$JobForm$FileSelected));
			case 'FileSelected':
				var file = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							maybeFile: $elm$core$Maybe$Just(file)
						}),
			...
			case 'Submit':
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$JobForm$Submitted,
						A2(
							$elm$core$Task$andThen,
													...
													[
														...
														$elm$json$Json$Encode$string(
															A2(
																...
																'\n',
																_List_fromArray(
																	['Job Application for Account Sales Executive', '', 'Full Name: ' + model.fullName, 'Email: ' + model.email, '', 'Message:', '', model.message])))),
														_Utils_Tuple2('Attachments', attachments)
													]))),
										headers: _List_Nil,
										method: 'POST',
				...
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$JobForm$View($author$project$JobForm$submitted)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								view: $author$project$JobForm$View($author$project$JobForm$failed)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$JobForm$view = function (model) {
	return function (_v0) {
		var toElement = _v0.a;
		return toElement(model);
	}(model.view);
};
var $author$project$JobForm$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2(
				A5(
					$author$project$JobForm$Model,
					$author$project$JobForm$View($author$project$JobForm$form),
					$elm$core$Maybe$Nothing,
					'',
					'',
					''),
		...
		update: $author$project$JobForm$update,
		view: $author$project$JobForm$view
	});
_Platform_export({'JobForm':{'init':$author$project$JobForm$main($elm$json$Json$Decode$string)(0)}});}(this));
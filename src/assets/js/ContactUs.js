...
var $author$project$ContactUs$Loading = {$: 1};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$ContactUs$init = function (_v0) {
	return _Utils_Tuple2($author$project$ContactUs$Loading, $elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$ContactUs$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ContactUs$Failure = {$: 0};
var $author$project$ContactUs$Success = function (a) {
	return {$: 2, a: a};
};
	...
	function (msg, model) {
		...
		if (!result.$) {
			...
			return _Utils_Tuple2(
				$author$project$ContactUs$Success(fullText),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2($author$project$ContactUs$Failure, $elm$core$Platform$Cmd$none);
		}
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('btn btn-block btn-primary lift'),
...
var $author$project$ContactUs$main = $elm$browser$Browser$element(
	{aB: $author$project$ContactUs$init, aM: $author$project$ContactUs$subscriptions, aP: $author$project$ContactUs$update, aQ: $author$project$ContactUs$view});
_Platform_export({'ContactUs':{'init':$author$project$ContactUs$main(

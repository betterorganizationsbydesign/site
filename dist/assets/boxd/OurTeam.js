...
var $author$project$OurTeam$init = function (_v0) {
...
var $author$project$OurTeam$update = F2(
	function (msg, model) {
...
var $author$project$OurTeam$slug = function (ss) {
		...
		A3(
			...
			A3(
				...
				A2(
					$elm$core$String$join,
					' ',
					A2($elm$core$List$map, $elm$core$String$trim, ss)))));
};
		...
		A2(
			...
			function (member) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('col-12 col-md-4 p-4 p-md-8')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('w-100 rounded-pill img-thumbnail'),
											$elm$html$Html$Attributes$src(
											'/who-we-are/assets/team/' + ($author$project$OurTeam$slug(
												_List_fromArray(
													[member.lastName, member.firstName])) + '.jpg'))
										]),
									_List_Nil)
								])),
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('pt-3 text-center')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$text(member.firstName + (' ' + member.lastName))
										]))
								])),
							A2(
							$elm$html$Html$div,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(member.position)
										]))
								])),
							A2(
							$elm$html$Html$div,
			...
			$author$project$OurTeam$team));
};
var $author$project$OurTeam$main = $elm$browser$Browser$element(
	{
		init: $author$project$OurTeam$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$OurTeam$update,
		view: $author$project$OurTeam$view
	});
_Platform_export({'OurTeam':{'init':$author$project$OurTeam$main(

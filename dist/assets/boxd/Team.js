...
var $author$project$Team$init = function (_v0) {
...
var $author$project$Team$update = F2(
	function (msg, model) {
...
var $author$project$Team$view = function (_v0) {
	return A2(
		$elm$html$Html$h1,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Team$main = $elm$browser$Browser$element(
	{
		aD: $author$project$Team$init,
		aQ: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		aT: $author$project$Team$update,
		aU: $author$project$Team$view
	});
_Platform_export({'Team':{'init':$author$project$Team$main(
